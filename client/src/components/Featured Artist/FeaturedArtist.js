...
const FeaturedArtist = props => (
    <div className="container featured-container">
        ...
        <div className="row">
            <div className="featured-artist-1 col-lg-4 col-md-4 col-sm-12">
            ...
            <div className="featured-artist-2 col-lg-4 col-md-4 col-sm-12">
                <div className="featured-content">
            ...
            <div className="featured-artist-3 col-lg-4 col-md-4 col-sm-12">
                <div className="featured-content">
